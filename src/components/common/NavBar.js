      ...
      <nav className="flex justify-between items-center xl:max-w-[1364px] mx-auto p-3">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="max-sm:hidden relative inline-block px-8 py-3 bg-gradient-to-r from-[#6AAECA] to-[#1F488E] hover:from-[#1F488E] hover:to-[#6AAECA] text-white rounded-full font-semibold hover:bg-[#2C5BB8] transform hover:scale-[1.01] transition-all duration-300 shadow-lg hover:shadow-xl"
          >
            Call Us
          </a>
          <div
