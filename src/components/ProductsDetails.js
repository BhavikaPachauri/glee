          ...
          <div className="flex flex-wrap items-center justify-between mb-10">
            <div className="lg:w-[41%]">
              <div className="bg-[#D9D9D9] rounded-[10px]">
                <img src={DummyImg} width={244} height={244} className="mx-auto" />
              </div>
            </div>
            <div className="lg:w-[50%]">
              <h3 className="text-black text-[34px] leading-[120%] mb-2">Product name</h3>
              <p className="text-[12px] text-black font-normal mb-2">
