            ...
            <div className="xl:max-w-[1365px] mx-auto px-3 lg:mt-[-90px]">
                <div className="flex flex-wrap-reverse lg:gap-0 gap-5 items-center">
                    <div className="lg:w-1/2 flex lg:gap-5 gap-3 mx-auto">
                        <div className="relative p-1.5 rounded-xl bg-gradient-border animate-gradient-border max-w-[280px] md:mt-[50px] mt-[25px]" data-aos="fade-down">
                        ...
                        <div className="relative p-1.5 rounded-xl bg-gradient-border animate-gradient-border max-w-[280px] md:mb-[50px] mb-[25px]" data-aos="fade-up">
                            <div className="relative rounded-lg overflow-hidden bg-gradient-to-r from-blue-400 via-blue-800 to-gray-400">
                    ...
                    <div className="lg:w-[45%]">
                        <h2 className="text-black text-[34px] leading-[120%] mb-4 lg:text-start text-center" data-aos="fade-left">About Us</h2>
                        <p className="text-[#59606C] text-[16px] lg:text-start text-center" data-aos="fade-left">M/s GLEE BIOTECH LTD (GLEE) is the visionary creation of its esteemed Promoters and a dedicated team, who collectively bring over 30 years of extensive experience in the Pharmaceutical Industry. At GLEE, our mission is to enhance and improve human lives by addressing medical needs with high-quality, meaningful healthcare products.
                        </p>
                    </div>
                </div>
            </div>
